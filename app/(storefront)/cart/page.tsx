...
export default async function CartPage() {
  ...
  if (cart.items.length === 0) {
    return (
      <div className="max-w-3xl mx-auto px-6 py-16 text-center">
        ...
        <p className="mt-2 text-sm text-gray-500">Explora el catálogo y agrega productos.</p>
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-10">
      <h1 className="text-2xl font-medium tracking-tight">Carrito</h1>
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      {!item.product.isActive && (
                        <div className="mt-2">
                          <Badge variant="danger">Ya no disponible</Badge>
                        </div>
                      )}
                    </div>
          ...
          <CardBody>
            ...
            <dl className="mt-4 space-y-2 text-sm">
              ...
              <p className="text-[11px] text-gray-400 pt-1">
                Impuestos y envío se calcularán en Fase 5.
              </p>
            </dl>
            <Link href="/checkout" className="mt-6 block">
              <Button className="w-full">
                Proceder al checkout · {formatMoney(subtotal, storeConfig.currency.base)}
              </Button>
            </Link>
            <Link
              href="/catalog"
